...
namespace HRMS
{
    public partial class frmBankAccountAssignSalary : Form
    {
        public frmBankAccountAssignSalary()
        {
            InitializeComponent();
        }

        private void frmBankAccountAssignSalary_Load(object sender, EventArgs e)
        {
